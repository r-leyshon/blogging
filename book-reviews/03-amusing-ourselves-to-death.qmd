...
an antiquated resistance to progress. I also believe that this would be an
ignorant treatment of his argument. Technological advancement has demonstrated
its ability to transform our culture. As a species we are locked into this
continuing compromise of how to implement immediate benefits while avoiding the
...
In the Imperative of Responsibility @ImperativeResponsibility, the author
...
Precautionary Principle and has equally garnered support and derision in
...
establish responsibility and pursue justice.

Critics of the Precautionary Principle would largely state that the bar to
enabling human progress is significantly raised and that this presents an
ethical quandary. Could you imagine an alternative reality where legislation
prevented mass adoption of the light bulb pending a full review of the
environmental and societal consequences. To undertake such a study would have
been impossible at that time, requiring an evaluation of innovations that had
yet to exist and processes that were yet to be understood. In the case of the
light bulb, this would include a multitide of additional jigsaw pieces, such as
...
effect and how electricity generated by fossil fuels contibuted to this, study
of human circadian rhythm and how this would be disrupted by the invention, an
evaluation of the impact of light pollution. At the same time, the case for the
technology would need to be evidenced in greater measure, evidencing the
greater productivity, safety, leisure and wellbeing that mass adoption of the
light bulb would induce would have been a monumental undertaking. This is to
say nothing of the consequential innovations that require or were inspired by
the filament lamp, or that in time we would improve it, making brighter, more
efficient devices that would mitigate much of that initial risk yet cause new
environmental consequences related to the use of plastics and production and
safe disposal of semiconductors.

The effort described above would take significant time. Time therein where the world literally sits
in the dark while awaiting the bureaucracy to arrive at a decision. Preparing
the world for a transformational technology may be considered an intractible
problem. The Collingridge dilemma states that until a technology has been
embedded in a society, you simply do not have enough information to build an
informed assessment of its risk, and then an inability to effectively regulate
that technology once it has been widely adopted. That doesn't mean we get to
wash our hands of the responsibility. A full and unbiased evaluation of the
consequences of innovation that is proportionate to the current evidence of
risk would be an improvement over a system accelerated by profit and disregard
for all else. Political lobbying, the reproducibility crisis in many fields of
research and our chronic inability to identify and prosecute fraudulent
behaviour have resulted in an economy where the cost of hindering technological
progress outweigh the consequences to its proliferation. To put it
bluntly, we have a prenatal societal capacity to defer gratification.

With the scales tipped in favour of progress above all else, the ramifications
for a society at the inception of generative artificial intelligence and with
artificial general intelligence now appearing to be more feasible than ever
before, many people of influence are involved in a richly diverse ethical
debate. Here are a couple of the more interesting threads from my recent social
media engagement.

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">In AI, the ratio of attention on hypothetical, future, forms of harm to actual, current, realized forms of harm seems out of whack. <br><br>Many of the hypothetical forms of harm, like AI &quot;taking over&quot;, are based on highly questionable hypotheses about what technology that does not…</p>&mdash; Andrew Ng (@AndrewYNg) <a href="https://twitter.com/AndrewYNg/status/1736577228828496179?ref_src=twsrc%5Etfw">December 18, 2023</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Earlier this week, <a href="https://twitter.com/POTUS?ref_src=twsrc%5Etfw">@POTUS</a> Biden issued an executive order on artificial intelligence – a breakthrough technology that has the power to change the world in ways we’re only beginning to understand.<br><br>I wanted to share some of the books, articles, and podcasts that have helped shape…</p>&mdash; Barack Obama (@BarackObama) <a href="https://twitter.com/BarackObama/status/1720458237315551378?ref_src=twsrc%5Etfw">November 3, 2023</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

Whether or not the future risks of generative AI will be well-managed will be
based upon the conversations that we are having today. My approach to coping
with this uncertainty has been to educate myself about the research and to
largely avoid sensational headlines. I would encourage those around me to use 
the open source tools that are being deployed and to discuss the implications
of their findings. At this juncture in our history, the role of the sceptic may
be more vital than ever. It is simply not enough to sway opinion by preaching
calamity or pigeonholing criticism as antiquated techno-scepticism. Finding
effective modes of discourse in order to promulgate AI awareness is the route
to ethically achieve the inegration of this latest transformative technology.
Examine the motives of those who do not give consideration to alternative
opinion - acknowledge that everyone's perception of reality is both informed
and limited by their unique perspective and values. The only means to
navigating this milestone must be to deepen our understanding of the technology
and each other.
