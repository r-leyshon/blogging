...
---
<figure class=center>
  <img class="shaded_box" style="display:block;margin-left:auto;margin-right:auto;width:100%;border:none;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Great_Britain-United_Kingdom_Topographic_Map.jpg/569px-Great_Britain-United_Kingdom_Topographic_Map.jpg?20220903003608"></img>
...
<img src="https://i.imgur.com/izZZjt4.png" display:block;margin-left:auto;margin-right:auto;width:60%;border:none; alt="ONS Open Geography Portal, LSOA 2021 boundaries interface.">
...
2. Pass the updated `params` dictionary to the `request_to_gdf` function
and use the `.explore()` method to visualise the map. Confirm that the
LSOAs returned match what you expected.
...
1. Update the `params` dictionary by changing the value of `where` to
`'1=1'`.
```{python filename=get_data.py}
#| code-fold: true
#| code-summary: "Show the Solution"
...
"where=1%3D1", see https://www.w3schools.com/tags/ref_urlencode.ASP for
...
<img src="https://i.imgur.com/oCkMdHW.png" display:block;margin-left:auto;margin-right:auto;width:60%;border:none; alt="LSOA 2021 Endpoint Interface.">
...
<img src="https://i.imgur.com/D1eyR0U.png" display:block;margin-left:auto;margin-right:auto;width:60%;border:none; alt="LSOA 2021 Endpoint Interface.">
