...
practice in testing to ensure the system state is unaffected by running the
...
Finally, we need a wrapper function that will take the above functions,
...
a wealth of utilities to help. Maybe you're working with a complex nested
...
as both fixtures return this type. And for more of a deep-dive with the pytest
api, I recommend reading the
