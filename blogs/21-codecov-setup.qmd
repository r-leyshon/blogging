...
categories:
    ...
    - Coverage
    - CI:CD
image: /./www/21-codecov-setup/intro-img.jpg
image-alt: "Futuristic cyberpunk shield"
toc: true
css: /./www/17-quarto-comments/styles.css
code-annotations: select
---
<img class=shaded_box src=/./www/21-codecov-setup/intro-img.jpg alt="Futuristic cyberpunk shield" style="display:block;margin-left:auto;margin-right:auto;width:40%;border:none;">
...
![CodeCov UI Repo Owner drop down. Click to expand.](/./www/21-codecov-setup/01.png){.lightbox .shaded_box}
...
![GitHub UI location of Actions Secrets & Variables. Click to expand.](/./www/21-codecov-setup/02.png){.lightbox .shaded_box}
