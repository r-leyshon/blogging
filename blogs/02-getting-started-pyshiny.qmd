...
author: "Rich Leyshon"
date: July 20 2023
description: "An interactive tutorial allowing newcomers to Shiny to build a basic application."
categories:         # delete categories as appropriate. using https://diataxis.fr/ documentation definitions.
    - Tutorial      # learning-oriented
    - Python Shiny
image: /./www/02-getting-started-python-shiny/intro-img.jpg
image-alt: "Robot software devs collaborating."
...
<img class=shaded_box src="/./www/02-getting-started-python-shiny/intro-img.jpg" alt="Robot software devs collaborating." style="display:block;margin-left:auto;margin-right:auto;width:40%;border:none;">
...
Try modifying the app provided in the previous examples to repeat the greeting
...
<div class=centerdiv>
  <iframe src="https://shinylive.io/py/editor/#code=NobwRAdghgtgpmAXGKAHVA6VBPMAaMAYwHsIAXOcpMAMwCdiYACAZwAsBLCbJjmVYnTJMAgujxM6lACZw6EgK4cAOhFVpUAfSVMAvEyVYoAcziaaAGyXSAFAEpVjiLJqs5ANzk2uqBWQnEfr7+biwsHKR2iKpMsZJwZAp0EEwAcqRwTuroeqLoNhraHBIsHnIOEGAAvgC6QA" title="Exercise 1 - repeat a message."></iframe>
</div>
