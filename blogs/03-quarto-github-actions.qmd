...
categories:         # delete categories as appropriate. using https://diataxis.fr/ documentation definitions.
    ...
    - CI:CD
    - Front End Dev
image: /./www/03-quarto-github-actions/intro-img.jpg
...
<img class=shaded_box src=/./www/03-quarto-github-actions/intro-img.jpg alt="Automated assembly line." style="display:block;margin-left:auto;margin-right:auto;width:40%;border:none;">
