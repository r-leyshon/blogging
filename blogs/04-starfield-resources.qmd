...
these cosmic artifacts. For this article, I opted to webscrape
<https://inara.cz/starfield/database/>, a site open to web crawling, and a 
straight forward web structure.

For those curious about the code behind the scenes,
[check it out on GitHub <i class="fa-brands fa-github fa-shake fa-lg" style="color: #030303;"></i>](https://github.com/r-leyshon/munge-starfield).
