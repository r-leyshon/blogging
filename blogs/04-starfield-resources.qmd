...
If you're interested in the python code used to scrape the data, check out the
code
[on GitHub <i class="fa-brands fa-github fa-shake fa-lg" style="color: #030303;"></i>](https://github.com/r-leyshon/munge-starfield). 
...
The value per gram ratio reveals which items are worth targeting, along with
a potentially subconscious predilection to explosives and a distaste for
