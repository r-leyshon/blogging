...
categories:         # delete categories as appropriate. using https://diataxis.fr/ documentation definitions.
    ...
    - Video games
    - Data analysis
image: /./www/04-starfield-resources/intro-img.jpg 
image-alt: "Starfield-esque scene."
...
<img class=shaded_box src="/./www/04-starfield-resources/intro-img.jpg" alt="Starfield-esque scene." style="display:block;margin-left:auto;margin-right:auto;width:40%;border:none;">
