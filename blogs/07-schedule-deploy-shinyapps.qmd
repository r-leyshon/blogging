...
description: "Using GitHub Actions to Automate Python Shiny App Deployments."
categories:         # delete categories as appropriate. using https://diataxis.fr/ documentation definitions.
    - How-to
    - Python Shiny
    - CI:CD
    - GitHub
image: /./www/07-schedule-deploy-shinyapps/intro-img.jpg
image-alt: "Futuristic synthwave grandfather clock."
toc: true
format:
  html:
    mermaid:
...
<img class=shaded_box src=/./www/07-schedule-deploy-shinyapps/intro-img.jpg alt="Futuristic synthwave grandfather clock." style="display:block;margin-left:auto;margin-right:auto;width:40%;border:none;">
...
<img class=shaded_box src=/./www/07-schedule-deploy-shinyapps/action-man.gif alt="Action man animation." style="display:block;margin-left:auto;margin-right:auto;width:40%;border:none;">
