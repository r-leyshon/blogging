...
To help visualise the differences in these approaches, here is a graph that
succinctly demonstrates the differences:

![](<INSERT GIT GRAPH>)

Inspecting the main branch histories after merging edits to a poem:
