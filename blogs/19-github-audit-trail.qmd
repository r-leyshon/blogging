...
categories:
    ...
    - VSCode
    - Git Grep
image: /./www/19-github-audit-trail/intro-img.jpg
image-alt: "A cute cat-like character inspects code with a magnifying glass."
toc: true
css: /./www/17-quarto-comments/styles.css
---

<img class=shaded_box src=/./www/19-github-audit-trail/intro-img.jpg alt="A cute cat-like character inspects code with a magnifying glass." style="display:block;margin-left:auto;margin-right:auto;width:40%;border:none;">
...
![Jerry Springer final word](/./www/19-github-audit-trail/js-optimized.gif){style="display:block;margin-left:auto;margin-right:auto;width:60%;" .shaded_box}
<br>
...
![Creating an issue in GitHub](/./www/19-github-audit-trail/01.png)
...
![Creating a new branch from an issue in GitHub](/./www/19-github-audit-trail/02.png){style="display:block;margin-left:auto;margin-right:auto;" width=50%}
...
![Merge strategy comparison diagram. Image © <a href="https://matt-rickard.com/squash-merge-or-rebase" target="_blank">Matt Rickard</a>.](/./www/19-github-audit-trail/1.webp)
...
![Comparing `main` and `feature` following rebase merge. Click to enlarge.](/./www/19-github-audit-trail/03.png){.lightbox}
...
![Comparing `main` and `feature` following a squash merge. Click to enlarge.](/./www/19-github-audit-trail/04.png){.lightbox}

Inspecting the automated squash merge commit message demonstrates how
GitHub summarises the activity from `feature` branch.

![Squash commit generated commit message.](/./www/19-github-audit-trail/05.png)
...
![Comparing `main` and `feature` following a merge commit. Click to enlarge.](/./www/19-github-audit-trail/06.png){.lightbox}
...
![GitHub Milestone interface. Click to expand.](/./www/19-github-audit-trail/07.png){.lightbox}
...
![Milestone on a GitHub roadmap. Click to expand.](/./www/19-github-audit-trail/08.png){.lightbox}
...
![GitHub blame view. Click to expand.](/./www/19-github-audit-trail/09.png){.lightbox}
...
![Launching Codespaces. Click to expand.](/./www/19-github-audit-trail/10.png){.lightbox}
...
![Running terminal operations with Codespaces. Click to expand.](/./www/19-github-audit-trail/11.png){.lightbox}
