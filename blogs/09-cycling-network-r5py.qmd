...
```{python}
del overview_map, largest_snaps, z_start

```

```{python}
point_plane.drop(columns=["geometry", "lines", "snap_dist_m"], axis=1, inplace=True)
...
# Tidy up
# tmp.cleanup()
del station_gdf, travel_time_matrix, point_plane
