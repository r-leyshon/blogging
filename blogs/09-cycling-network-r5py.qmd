...
create_point_grid(bbox_list=[-0.5917,51.2086,0.367,51.7575], stepsize=5000).explore(min_zoom=9)
...
x,y - long, lat. If you select an alternative method for mapping visuals,
