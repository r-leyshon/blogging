...
categories:         # delete categories as appropriate. using https://diataxis.fr/ documentation definitions.
    ...
    - Authentication
    - Verification
image: /./www/05-signed-commits/intro-img.webp
image-alt: "Verification badge."
toc: true 
execute: 
...
format:
  html:
    mermaid:
      theme: default
---
<img src="/./www/05-signed-commits/intro-img.webp" alt="Verification badge." style="display:block;margin-left:auto;margin-right:auto;width:60%;border:none;">
