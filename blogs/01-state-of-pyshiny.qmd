...
author: "Rich Leyshon"
date: July 20 2023
description: "An overview of the progress of Python Shiny, and where it could possibly go."
categories:         # delete categories as appropriate. using https://diataxis.fr/ documentation definitions.
    - Explanation   # understanding-oriented
    - Python Shiny
image: /./www/01-python-shiny/shiny-python.jpg
image-alt: "AI-generated drawing of a shiny python."
toc: false # toc overlapping iframe for shinyhelper
format:
  html:
    mermaid:
      theme: default
...
<figure class=center>
  <img class=shaded_box src=/./www/01-python-shiny/shiny-python.jpg alt="AI-generated drawing of a shiny python." width=300px>
...
<div class=centerdiv>
  <iframe src="https://richleysh84.shinyapps.io/pyrosm-cities-app/" title="Python Shiny OpenStreetMap Application"></iframe>
</div>
...
#### 1. Reactlog.
<center>
  <img src="/./www/01-python-shiny/reactlog-logo.svg" width=30%>
</center>
...
<center>
  <img class=shaded_box src="/./www/01-python-shiny/reactlog-ui-optimized.gif" width=100%>
</center>
...
<center>
  <img src="/./www/01-python-shiny/shinyhelper-logo.png" width=30%>
</center>
