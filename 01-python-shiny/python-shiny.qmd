...
<figure class=center>
  <img class=shaded_box src=/./www/01-python-shiny/shiny-python.png alt="AI-generated drawing of a shiny python.">
...
<div class="centerdiv shaded_box">
...
This package allows you to launch an app, showing you useful insights about the performance and reactive flow of your app. It's an app inception. It can be used in a variety of modes, you can record yourself clicking away on your app and then pause the interface to inspect variable statuses.
