...
application and then expanding on some of the more subtle considerations in the
reactive flow of the backend. I'll throw in some common 'gotchas' for good
measure. 
...
Each Shiny application comes in two distinct sections.
