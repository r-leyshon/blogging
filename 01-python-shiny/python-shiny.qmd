...
def server(input, output, session):
    ...
    def greeting():
        ...
        format the string in a polite sentence and format it as an HTML               output for the UI to show.
        """
...
If I haven't lost you yet, well done! Debugging applications can be a very frustrating process - part intuition earned from hours of shiny debugging, part stack overflow (or chat GPT) and part coping mechanisms. I'll cover some of those in the Tips section.
